...
export async function GET() {
  try {
    ...
    // Get all locations with GMB connection
    ...
    for (const location of locations) {
      try {
        ...
        const reviewResponse = await fetch(
          `https://mybusiness.googleapis.com/v4/${location.gmbAccountId}/locations/${location.gmbLocationId}/reviews?orderBy=updateTime`,
          {
            headers: {
        ...
        // Filter reviews based on lastFetchedTimestamp
